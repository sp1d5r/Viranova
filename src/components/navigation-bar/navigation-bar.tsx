...
export const NavigationBar: React.FC<NavigationBarProps> = ({ className = '' }) => {
    ...
    return <div className="w-full flex sticky top-0 bg-background min-h-20 shadow justify-start items-center gap-[90px] px-10 py-5 navigation-bar z-50 ">
        {
            ...
            <div className={"hidden md:flex gap-5 justify-center items-center "}>
                ...
                { authState.isAuthenticated && <a href="/settings">
                    <svg className="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true"
                        ...
                        <path stroke="currentColor" strokeLinecap="square" strokeLinejoin="round" strokeWidth="1"
