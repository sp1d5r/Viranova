    ...
    return <div className="max-w-sm border  rounded-lg shadow bg-gray-800 border-gray-700 overflow-hidden">
        ...
        <div className="p-5">
            ...
            <div className="flex gap-2">
                ...
                <button  onClick={() => {console.log(userVideo)}} type="button" className="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm p-2.5 text-center inline-flex items-center me-2 ">
