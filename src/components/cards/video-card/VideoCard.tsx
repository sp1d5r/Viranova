...
export const VideoCard: React.FC<VideoCardProps> = ({video}) => {
    return <div className={"flex flex-col py-5 flex-1  justify-evenly items-center gap-2 min-w-[200px] min-h-[400px] bg-white/5 hover:bg-white/10 rounded-xl backdrop-blur-sm"}>
