...
export const HeroSection: React.FC<HeroSectionProps> = ({ className = '' }) => (
    <div className={className + 'bg-background text-accent w-full min-h-[80vh] flex gap-5 justify-center items-center md:flex-wrap-reverse  px-5 flex-col-reverse sm:flex-row container'  }>
